...
static createStatePayload(builder:flatbuffers.Builder, playersOffset:flatbuffers.Offset):flatbuffers.Offset {
  StatePayload.startStatePayload(builder);
  StatePayload.addPlayers(builder, playersOffset);
