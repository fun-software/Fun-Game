...
export class LeaveGameResponsePayload
  implements flatbuffers.IUnpackableObject<LeaveGameResponsePayloadT>
{
  ...
  static getRootAsLeaveGameResponsePayload(
    bb: flatbuffers.ByteBuffer,
    obj?: LeaveGameResponsePayload,
  ): LeaveGameResponsePayload {
    return (obj || new LeaveGameResponsePayload()).__init(
      bb.readInt32(bb.position()) + bb.position(),
      bb,
    );
  }

  static getSizePrefixedRootAsLeaveGameResponsePayload(
    bb: flatbuffers.ByteBuffer,
    obj?: LeaveGameResponsePayload,
  ): LeaveGameResponsePayload {
...
export class LeaveGameResponsePayloadT implements flatbuffers.IGeneratedObject {
  constructor(public code: ResponseCode = ResponseCode.OK, public game: GameT | null = null) {}
