...
export class StatePayload implements flatbuffers.IUnpackableObject<StatePayloadT> {
  ...
  static getSizePrefixedRootAsStatePayload(
  ...
  gameState(obj?: GameState): GameState | null {
    ...
    return offset
      ? (obj || new GameState()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!)
      : null;
  }
  ...
  unpackTo(_o: StatePayloadT): void {
    ...
    _o.chat = this.bb!.createObjList<ChatMessage, ChatMessageT>(
      this.chat.bind(this),
      this.chatLength(),
    );
  }
