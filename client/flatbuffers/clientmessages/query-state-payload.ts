...
export class QueryStatePayload implements flatbuffers.IUnpackableObject<QueryStatePayloadT> {
  ...
  static getRootAsQueryStatePayload(
    bb: flatbuffers.ByteBuffer,
    obj?: QueryStatePayload,
  ): QueryStatePayload {
    return (obj || new QueryStatePayload()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
  }

  static getSizePrefixedRootAsQueryStatePayload(
    bb: flatbuffers.ByteBuffer,
    obj?: QueryStatePayload,
  ): QueryStatePayload {
  ...
  static createQueryStatePayload(
  ...
  unpack(): QueryStatePayloadT {
    return new QueryStatePayloadT(this.user() !== null ? this.user()!.unpack() : null);
  }
...
export class QueryStatePayloadT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return QueryStatePayload.createQueryStatePayload(builder, user);
  }
}
