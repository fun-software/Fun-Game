...
export class JoinGamePayload implements flatbuffers.IUnpackableObject<JoinGamePayloadT> {
  ...
  static getRootAsJoinGamePayload(
  ...
  static getSizePrefixedRootAsJoinGamePayload(
    bb: flatbuffers.ByteBuffer,
    obj?: JoinGamePayload,
  ): JoinGamePayload {
  ...
  unpack(): JoinGamePayloadT {
    return new JoinGamePayloadT(this.user() !== null ? this.user()!.unpack() : null, this.gameId());
  }
...
export class JoinGamePayloadT implements flatbuffers.IGeneratedObject {
  constructor(public user: UserT | null = null, public gameId: string | Uint8Array | null = null) {}
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return JoinGamePayload.createJoinGamePayload(builder, user, gameId);
  }
}
