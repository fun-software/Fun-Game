...
static getSizePrefixedRootAsNewGamePayload(bb:flatbuffers.ByteBuffer, obj?:NewGamePayload):NewGamePayload {
...
static createNewGamePayload(builder:flatbuffers.Builder, userOffset:flatbuffers.Offset):flatbuffers.Offset {
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return NewGamePayload.createNewGamePayload(builder,
    user
  );
}
}
