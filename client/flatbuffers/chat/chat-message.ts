...
export class ChatMessage implements flatbuffers.IUnpackableObject<ChatMessageT> {
  ...
  static getSizePrefixedRootAsChatMessage(
  ...
  static finishSizePrefixedChatMessageBuffer(
  ...
  static createChatMessage(
    ...
    authorOffset: flatbuffers.Offset,
  ): flatbuffers.Offset {
  ...
  unpack(): ChatMessageT {
    return new ChatMessageT(this.source(), this.message(), this.author());
  }
...
export class ChatMessageT implements flatbuffers.IGeneratedObject {
  ...
  pack(builder: flatbuffers.Builder): flatbuffers.Offset {
    ...
    return ChatMessage.createChatMessage(builder, this.source, message, author);
  }
}
