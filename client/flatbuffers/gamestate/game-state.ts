...
export class GameState implements flatbuffers.IUnpackableObject<GameStateT> {
  ...
  players(obj?: PlayerRoles): PlayerRoles | null {
    ...
    return offset
      ? (obj || new PlayerRoles()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!)
      : null;
  }
  ...
  static finishSizePrefixedGameStateBuffer(
...
export class GameStateT implements flatbuffers.IGeneratedObject {
  constructor(public game: GameT | null = null, public players: PlayerRolesT | null = null) {}
