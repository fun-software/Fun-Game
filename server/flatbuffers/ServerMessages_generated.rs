...
impl<'a> StatePayload<'a> {
  ...
  pub fn players(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(StatePayload::VT_PLAYERS, None)}
  }
}
...
impl<'a: 'b, 'b> StatePayloadBuilder<'a, 'b> {
  ...
  pub fn add_players(&mut self, players: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StatePayload::VT_PLAYERS, players);
  }
  #[inline]
...
impl<'a> ServerMessage<'a> {
  ...
  pub fn timestamp(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(ServerMessage::VT_TIMESTAMP, Some(0)).unwrap()}
  }
  #[inline]
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_union::<ServerMessagePayload, _>("payload_type", Self::VT_PAYLOAD_TYPE, "payload", Self::VT_PAYLOAD, false, |key, v, pos| {
        match key {
          ServerMessagePayload::JoinPayload => v.verify_union_variant::<flatbuffers::ForwardsUOffset<JoinPayload>>("ServerMessagePayload::JoinPayload", pos),
          ServerMessagePayload::LeavePayload => v.verify_union_variant::<flatbuffers::ForwardsUOffset<LeavePayload>>("ServerMessagePayload::LeavePayload", pos),
          ServerMessagePayload::ChatPayload => v.verify_union_variant::<flatbuffers::ForwardsUOffset<ChatPayload>>("ServerMessagePayload::ChatPayload", pos),
...
impl<'a: 'b, 'b> ServerMessageBuilder<'a, 'b> {
  ...
  pub fn add_timestamp(&mut self, timestamp: i64) {
    self.fbb_.push_slot::<i64>(ServerMessage::VT_TIMESTAMP, timestamp, 0);
  }
  #[inline]
